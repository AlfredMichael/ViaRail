...
namespace RailwayReservationSystem
{
    public partial class deleteadministrator : Form
    {
        ...
        private void deleteadministrator_Load(object sender, EventArgs e)
        {
        ...
        private void AddStationButton_Click(object sender, EventArgs e)
        {
            ...
            {
                db.openConnection();
                MySqlCommand cmd = new MySqlCommand("DELETE FROM `adminregistration` WHERE adminname='" + TextBoxAdminName.Text + "'", db.getConnection());
