...
{
    public partial class trainTrips : Form
    {
        ...
        private void trainTrips_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Hide();
            Addtraintrips f9 = new Addtraintrips();
            f9.ShowDialog();
            this.Close();
        }
        ...
        {
            this.Hide();
            viewBookings f11 = new viewBookings();
            f11.ShowDialog();
            this.Close();
        }
    }
